            ...
            {dataValue.map((value, index) => (
                <Link to={`/${value.id}`} key={value.id}>
                    <div className="md:mx-48">
                        <div className="md:mx-auto mt-10 mb-6 rounded-lg bg-card-bg border-2 border-border-colour hover:cursor-pointer  hover:border-[#7c5dfa] hover:border-2 justify-center">
